...
**CRITICAL: All OpenSpec documentation MUST be in English.**

OpenSpec proposals, specifications, design documents, and all related documentation within the `openspec/` directory must be written in English. This ensures:

- **International Collaboration**: All team members and contributors can understand and review specifications
- **AI Assistant Compatibility**: AI coding assistants work most effectively with English documentation
- **Consistency**: Uniform language across the entire specification system

### Examples

**CORRECT:**
```markdown
# Change: Add physics-based bone simulation

## Why
Current animation system lacks realistic bone dynamics for hair and clothing.

## What Changes
- Integrate Rapier3D physics engine
- Add bone-to-rigidbody binding system
```
...
- `specs/**/spec.md` - Capability specifications
- Comments and examples in spec files

### What This Does NOT Apply To

- Source code comments (may use project's natural language)
- User-facing documentation outside `openspec/`
