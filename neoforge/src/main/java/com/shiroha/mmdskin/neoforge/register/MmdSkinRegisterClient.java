...
public class MmdSkinRegisterClient {
    ...
    private static void registerNetworkSenders() {
        ...
        ActionWheelNetworkHandler.setNetworkSender(animId -> {
            ...
            if (player != null) {
                ...
                MmdSkinNetworkPack.sendToServer(new MmdSkinNetworkPack.ExamplePayload(1, player.getUUID(), animId));
            }
        });
        ...
        com.shiroha.mmdskin.ui.ModelSelectorNetworkHandler.setNetworkSender(modelName -> {
            ...
            if (player != null) {
                ...
                MmdSkinNetworkPack.sendToServer(new MmdSkinNetworkPack.ExamplePayload(3, player.getUUID(), modelName));
            }
        });
        ...
        PlayerModelSyncManager.setNetworkBroadcaster((playerUUID, modelName) -> {
            ...
            MmdSkinNetworkPack.sendToServer(new MmdSkinNetworkPack.ExamplePayload(3, playerUUID, modelName));
        });
        ...
        MaidModelNetworkHandler.setNetworkSender((entityId, modelName) -> {
            LocalPlayer player = MCinstance.player;
            if (player != null) {
                MmdSkinNetworkPack.sendToServer(new MmdSkinNetworkPack.ExamplePayload(4, player.getUUID(), entityId, modelName));
            }
        });
        ...
        MaidActionNetworkHandler.setNetworkSender((entityId, animId) -> {
            ...
            if (player != null) {
                ...
                MmdSkinNetworkPack.sendToServer(new MmdSkinNetworkPack.ExamplePayload(5, player.getUUID(), entityId, animId));
            }
        });
    }
    ...
    public static void onRegisterKeyMappings(RegisterKeyMappingsEvent event) {
        event.registerKeyMapping(keyConfigWheel);
        event.registerKeyMapping(keyMaidConfigWheel);
